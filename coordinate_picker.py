...
def make_pitch():
    ...
    fig.add_trace(go.Scatter(
        ...
        showlegend=False,
        hovertemplate="Selected: x=%{x}<br>y=%{y}<extra></extra>"
    ))
...
st.write("Κάνε κλικ ή μικρό box-select πάνω στο γήπεδο για να πάρεις x και y.")
...
st.write("Χρησιμοποίησε αυτά τα νούμερα στο season_shots.csv.")
